    ...
    <>
      <table className="table table-sm">
        <thead>
          <tr>
            <th scope="col">
              <button className={interval === 1 ? "btn btn-outline-warning active" : "btn btn-outline-warning"}
            ...
            <th scope="col">
              <button className={interval === 7 ? "btn btn-outline-warning active" : "btn btn-outline-warning"}
            ...
            <th scope="col">
              <button className={interval === 14 ? "btn btn-outline-warning active" : "btn btn-outline-warning"}
            ...
            <th scope="col">
              <button className={interval === 30 ? "btn btn-outline-warning active" : "btn btn-outline-warning"}
